...
;// CONCATENATED MODULE: ./src/modules/simpleValidation.js
function propValidation(propLength, limit) {
    return propLength <= limit;
}

;// CONCATENATED MODULE: ./src/modules/constants.js
